...
normal<-function(data,n,startm,startsd,lowsd=0,upsd=50){
...
weibull<-function(data,n,starta,startb,lowa=0,upa=100,lowb=0,upb=100){
...
lognormal<-function(data,n,startm,startsd,lowsd=0,upsd=10){
...
beta<-function(data,n,starta,startb,lowa=0,upa=40,lowb=0,upb=40){
...
for (i in 1:nrow(ds)){
  ...
  er1<-tryCatch(normal(data,n,startmn,startsdn,0,1),error=function(e) 1)
  if (typeof(er1)=="list"){
    fit1<-normal(data,n,startmn,startsdn,0,1)
  ...
  er2<-tryCatch(weibull(data,n,startaw,startbw,upa=20,upb=20),error=function(e) 1)
  if (typeof(er2)=="list"){
    fit2<-weibull(data,n,startaw,startbw,upa=20,upb=20)
  ...
  er4<-tryCatch(beta(data,n,0.5,1.5,upa=20,upb=20),error=function(e) 1)
  if (typeof(er4)=="list"){
    fit4<-beta(data,n,0.5,1.5,upa=20,upb=20)
  ...
  if (model[i]=="normal"){
    fit<-normal(data,n,startmn,startsdn,0,1)
    ds$mw[i]<-fit$par[1]
    ds$sdw[i]<-fit$par[2]
  }
  ...
  if(model[i]=="weibull"){
    fit<-weibull(data,n,startaw,startbw,upa=20,upb=20)
  ...
  if(model[i]=="beta"){
    fit<-beta(data,n,0.5,1.5,upa=20,upb=20)
